...
public class LegalTerminationCauseSpecification {

    private LegalTerminationCauseSpecification() {}

    public static Specification<LegalTerminationCause> withFilters(String search, Boolean active,
