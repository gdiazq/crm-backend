...
public class NoReHiredCauseSpecification {

    private NoReHiredCauseSpecification() {}

    public static Specification<NoReHiredCause> withFilters(String search, Boolean active,
