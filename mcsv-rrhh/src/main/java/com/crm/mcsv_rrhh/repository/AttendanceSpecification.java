...
public final class AttendanceSpecification {
    ...
    public static Specification<Attendance> withFilters(String search,
                                                        Long employeeId,
                                                        Integer costCenter,
                                                        Long statusId,
                                                        LocalDate dateFrom,
        ...
        return (root, query, cb) -> {
            ...
            Join<Attendance, Employee> empJoin = needsEmpJoin ? root.join("employee", JoinType.LEFT) : null;
            ...
            if (costCenter != null) predicates.add(cb.equal(root.get("costCenter"), costCenter));
            if (statusId != null) predicates.add(cb.equal(root.get("statusId"), statusId));
