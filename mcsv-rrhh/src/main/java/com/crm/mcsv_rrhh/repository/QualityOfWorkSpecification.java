...
public class QualityOfWorkSpecification {

    private QualityOfWorkSpecification() {}

    public static Specification<QualityOfWork> withFilters(String search, Boolean active,
