...
public class SafetyComplianceSpecification {

    private SafetyComplianceSpecification() {}

    public static Specification<SafetyCompliance> withFilters(String search, Boolean active,
