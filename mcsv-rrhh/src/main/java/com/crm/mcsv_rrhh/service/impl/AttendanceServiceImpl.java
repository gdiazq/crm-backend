...
public class AttendanceServiceImpl implements AttendanceService {
    ...
    public byte[] exportCsv(String search,
        ...
        StringBuilder csv = new StringBuilder("ID,RUT,Empleado,Centro de Costo,Proyecto,Fecha Entrada,Hora Entrada,Fecha Salida,Hora Salida,Horas,Estado Base,Licencia Activa,Notas,Fecha Creación\n");
        rows.forEach(row -> csv.append(row.getId()).append(',')
                ...
                .append(row.getCheckInDate() != null ? row.getCheckInDate() : "").append(',')
                .append(row.getCheckInTime() != null ? row.getCheckInTime() : "").append(',')
                .append(row.getCheckOutDate() != null ? row.getCheckOutDate() : "").append(',')
                .append(row.getCheckOutTime() != null ? row.getCheckOutTime() : "").append(',')
    ...
    private AttendanceResponse toResponse(Attendance entity) {
        ...
        return AttendanceResponse.builder()
                ...
                .checkInDate(entity.getCheckInTime() != null ? entity.getCheckInTime().toLocalDate() : null)
                .checkInTime(entity.getCheckInTime() != null ? entity.getCheckInTime().toLocalTime() : null)
                .checkOutDate(entity.getCheckOutTime() != null ? entity.getCheckOutTime().toLocalDate() : null)
                .checkOutTime(entity.getCheckOutTime() != null ? entity.getCheckOutTime().toLocalTime() : null)
