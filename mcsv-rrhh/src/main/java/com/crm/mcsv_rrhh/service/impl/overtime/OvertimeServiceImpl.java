package com.crm.mcsv_rrhh.service.impl.overtime;
...
import com.crm.mcsv_rrhh.repository.overtime.OvertimeSpecification;
import com.crm.mcsv_rrhh.repository.overtime.OvertimeTypeRepository;
...
public class OvertimeServiceImpl implements OvertimeService {
    ...
    public PagedResponse<OvertimeResponse> list(String search,
        ...
        long active = resolveCountByStatusName(RequestStatus.APPROVED.getDisplayName());
        long pending = resolveCountByStatusNames(List.of(
