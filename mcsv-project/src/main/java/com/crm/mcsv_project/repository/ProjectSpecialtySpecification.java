...
public class ProjectSpecialtySpecification {

    private ProjectSpecialtySpecification() {}

    public static Specification<ProjectSpecialty> withFilters(String search, Boolean active,
